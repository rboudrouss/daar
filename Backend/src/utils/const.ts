...
export const TOKENIZER_IGNORE_STOP_WORDS = Boolean(process.env.TOKENIZER_IGNORE_STOP_WORDS)
...
export const TOKENIZER_KEEP_POSITIONS = Boolean(process.env.TOKENIZER_KEEP_POSITIONS);
...
export const SEARCH_HIGHLIGHT_CONTEXT_LENGTH_BEFORE = parseInt(process.env.SEARCH_HIGHLIGHT_CONTEXT_LENGTH_BEFORE || "75");
export const SEARCH_HIGHLIGHT_CONTEXT_LENGTH_AFTER = parseInt(process.env.SEARCH_HIGHLIGHT_CONTEXT_LENGTH_AFTER || "75");
