...
import { nfaFromSyntaxTree, matchNfa, type NFA } from '../src/NFA';
import { parseRegex } from '../src/RegexParser';
import { EPSILON, DOT } from '../src/const';
...
describe('NFA - Error Handling', () => {
  it('should throw error for unknown node type', () => {
    ...
    expect(() => nfaFromSyntaxTree(invalidTree)).toThrow('Type de noeud inconnu');
  });
});
